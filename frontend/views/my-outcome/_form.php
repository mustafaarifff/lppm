...
<div class="outcome-form">
    ...
    <?= $form->field($model, 'id')->textInput(['readonly' => !$model->isNewRecord,'maxlength' => true, 'class' => 'uk-input uk-form-large tm-form-xlarge uk-border-rounded']) ?>
    ...
    <?= $form->field($model, 'nomor')->textInput(['maxlength' => true, 'class' => 'uk-input uk-form-large tm-form-xlarge uk-border-rounded']) ?>
