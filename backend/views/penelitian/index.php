...
/* @var $searchModel common\models\PenelitianSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Penelitian');
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        'view' => function ($url, $model, $key) {     // render your custom button
                                            return "<a class='btn btn-lg btn-circle btn-alt-danger mr-5 mb-5' href='" . \yii\helpers\Url::to(['penelitian/view', 'id' => $model->no_sk]) . "'><span class='fa fa-list'></span></a>";
                                        },
